...
For the rest of the calculations, we will delete rows that do not have a learner ID (as incorrect data, because ID is necessary). So now, we have `r number_of_part_no_na` observations.
